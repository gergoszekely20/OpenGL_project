...
glm::vec3 lightMovementDirection(1.0f, 0.0f, 0.0f);
...
void processMovement() {
    ...
    if (pressedKeys[GLFW_KEY_Z]) {
        lightMovementDirection += glm::vec3(0.0f, 0.3f, 0.0f);
    }
...
void initModels() {
    mediv_scene.LoadModel("models/medieval_scene/medieval_scene.obj");
